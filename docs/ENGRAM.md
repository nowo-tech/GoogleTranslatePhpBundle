...
- FrankenPHP worker: `ResetInterface` / `kernel.reset` **and** `ResetTranslatorsOnRequestSubscriber` (safe when kernel is not reset / `services_resetter` off). See [FRANKENPHP-WORKER-AUDIT.md](FRANKENPHP-WORKER-AUDIT.md).
